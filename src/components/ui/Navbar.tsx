  ...
  return (
    <nav className="w-full h-16 bg-slate-900 border-b border-white/10 flex items-center justify-between px-6 lg:px-12 sticky top-0 z-50 shadow-md">
      <div className="flex items-center space-x-2">
        ...
        <Link href="/dashboard" className="font-bold text-lg tracking-wider text-white">EvComp</Link>
      </div>

      <div className="hidden md:flex items-center space-x-8 text-sm font-semibold">
        <Link href="/dashboard" className="text-gray-300 hover:text-white transition-colors">HOME / EVENTOS</Link>
